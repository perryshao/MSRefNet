...
from dataset.dataloader_hico import Rescale, ToTensor, hico_Dataset, hico_collate
...
dataloader_train = DataLoader(hico_train, batch_size,
                              shuffle=True, collate_fn=hico_collate, num_workers=16,
                              worker_init_fn=_init_fn)  # num_workers=batch_size
dataloader_test = DataLoader(hico_test, batch_size,
                             shuffle=False, collate_fn=hico_collate, num_workers=16,
                             worker_init_fn=_init_fn)  # num_workers=batch_size
