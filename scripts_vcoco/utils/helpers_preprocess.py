...
PER_PATH_train_s = all_data_dir + 'KP_Detections_vcoco/train/'
PER_PATH_test_s = all_data_dir + '/KP_Detections_vcoco/val/'
...
object_class = ['1self', '2bicycle', '3car', '4motorcycle', '5airplane', '6bus', '7train', '8truck', '9boat', '10traffic light',
                '11fire hydrant', '12stop sign', '13parking meter', '14bench', '15bird', '16cat',
                '17dog', '18horse', '19sheep', '20cow', '21elephant', '22bear', '23zebra', '24giraffe',
                '25backpack', '26umbrella', '27handbag', '28tie', '29suitcase', '30frisbee', '31skis',
                '32snowboard', '33sports ball', '34kite', '35baseball bat', '36baseball glove', '37skateboard',
                '38surfboard', '39tennis racket', '40bottle', '41wine glass', '42cup', '43fork', '44knife',
                '45spoon', '46bowl', '47banana', '48apple', '49sandwich', '50orange', '51broccoli',
                '52carrot', '53hot dog', '54pizza', '55donut', '56cake', '57chair', '58couch', '59potted plant',
                '60bed', '61dining table', '62toilet', '63tv', '64laptop', '65mouse', '66remote',
                '67keyboard', '68cell phone', '69microwave', '70oven', '71toaster', '72sink', '73refrigerator',
                '74book', '75clock', '76vase', '77scissors', '78teddy bear', '79hair drier', '80toothbrush']
...
def get_detections(segment_key, flag):
    if flag == 'train':
        ...
        cur_per_path_s = PER_PATH_train_s + "COCO_train2014_%.12i.json" % (segment_key)
        SCORE_TH = 0.6
        SCORE_OBJ = 0.3
        ...
        cur_per_path_s = PER_PATH_test_s + "COCO_val2014_%.12i.json" % (segment_key)
        SCORE_TH = 0.6
        SCORE_OBJ = 0.3
        select_threshold = 2000000
    elif flag == 'val':
    ...
    img_W = detections['W']
    shape = [img_W, img_H]
    persons_d, objects_d = analyze_detections(detections, detections_per, SCORE_TH,
                                              SCORE_OBJ) 
    ...
    if len(d_p_boxes) > select_threshold:
        d_p_boxes, scores_persons, class_id_humans, person_kp = d_p_boxes[0:select_threshold], scores_persons[
                                                                                               0:select_threshold], class_id_humans[
                                                                                                                    0:select_threshold], person_kp[
                                                                                                                                         0:select_threshold]
    ...
    object_one_hot = [one_hot[0]]
    for i, j in enumerate(class_id_objects):
        object_one_hot.append(one_hot[j-1])
...
def get_compact_detections(segment_key, flag):
    ...
    persons_kp_pure = np.zeros([no_person_dets, 17, 2], np.float32)
    ...
    if no_person_dets != 0:
        ...
        persons_kp_pure = np.array(persons_kp, np.float32)
    ...
    return {'person_bbx': persons_np, 'objects_bbx': objects_np,
            ...
            'class_id_objects': class_id_objects, 'shape': shape, 'kp': persons_kp, 'object_one_hot': object_one_hot}
